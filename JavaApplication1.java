...
public class JavaApplication1 {
    ...
    public static void main(String[] args) {
        ...
        int desicion=2,valor=0,num, filas,columnas,comida,paredes,trampas, paredess,trampass,comidaa, tablero,pu = 1,name;
       ...
       if(vidas !=3 &&vidas !=2 &&vidas !=1){
        ...
        if(total<=0){
              ...
              break;
                ...
                break ;
           case 2:
               System.out.println("contador"+calificacion);
